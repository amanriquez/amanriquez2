...
var exponent = function(base, exp) {
  ...
  if (base**exp === 1) return 1;
  
  if (exp < 0) return 1/base*exponent(base, exp+1).toFixed(4);
...
var reverse = function(string) {
  ...
  return string === '' ? '' : reverse(string.slice(1)) + string[0];
...
var compress = function(list) {
  ...
  return arri.concat(compress(list.slice(1)));
...
var minimizeZeroes = function(list) {
  ...
  return arri.concat(minimizeZeroes(list.slice(1)));
